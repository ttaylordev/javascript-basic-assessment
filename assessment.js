...
const getValueOfProperty = (obj, name) => {
  return obj[name];
}
...
const outside = (temp, hum, cloudiness) => {
  if (temp > 80 && hum > 40) {
...
const hey = 'Hey!'
const holla = function(){
	return hey;
}
const callerBack = (holla, back) => {
	let newStr = holla(back + ' back');
  return newStr;
}
